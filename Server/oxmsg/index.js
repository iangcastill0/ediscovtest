...
var fs;
function get_fs() { return fs || (fs = require$$0__default$1["default"]); }
...
exports.MessageEditorFormat = void 0;
...
})(exports.MessageEditorFormat || (exports.MessageEditorFormat = {}));
...
class Email extends Message {
    ...
    _writeToStorage() {
        ...
        if (this.messageEditorFormat !== exports.MessageEditorFormat.EDITOR_FORMAT_DONTKNOW) {
...
class Attachment {
    ...
    fileName, contentId = "", type = exports.AttachmentType.ATTACH_BY_VALUE, renderingPosition = -1, isContactPhoto = false) {
        this.data = data;
    ...
    writeProperties(storage, index) {
        ...
        switch (this.type) {
            case exports.AttachmentType.ATTACH_BY_VALUE:
            case exports.AttachmentType.ATTACH_EMBEDDED_MSG:
                ...
                break;
            case exports.AttachmentType.ATTACH_BY_REF_ONLY:
            case exports.AttachmentType.ATTACH_BY_REFERENCE:
            case exports.AttachmentType.ATTACH_BY_REF_RESOLVE:
            case exports.AttachmentType.NO_ATTACHMENT:
            case exports.AttachmentType.ATTACH_OLE:
                throw new Error(`Attachment type "${exports.AttachmentType[this.type]} is not supported`);
        }
        if (this.contentId) {
...
exports.CFB = cfb$1;
exports.Email = Email;
exports.bigInt64FromParts = bigInt64FromParts;
exports.dateToFileTime = dateToFileTime;
exports.fileTimeToDate = fileTimeToDate;
exports.utf16LeArrayToString = utf16LeArrayToString;
