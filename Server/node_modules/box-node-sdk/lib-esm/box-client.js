...
// ------------------------------------------------------------------------------
const ai_generated_1 = __importDefault(require("./managers/ai.generated"));
const collaboration_allowlist_1 = __importDefault(require("./managers/collaboration-allowlist"));
const collaborations_1 = __importDefault(require("./managers/collaborations"));
const collections_1 = __importDefault(require("./managers/collections"));
const comments_1 = __importDefault(require("./managers/comments"));
const device_pins_1 = __importDefault(require("./managers/device-pins"));
const enterprise_1 = __importDefault(require("./managers/enterprise"));
const events_1 = __importDefault(require("./managers/events"));
const files_1 = __importDefault(require("./managers/files"));
const folders_1 = __importDefault(require("./managers/folders"));
const groups_1 = __importDefault(require("./managers/groups"));
const legal_hold_policies_1 = __importDefault(require("./managers/legal-hold-policies"));
const metadata_1 = __importDefault(require("./managers/metadata"));
const recent_items_1 = __importDefault(require("./managers/recent-items"));
const retention_policies_1 = __importDefault(require("./managers/retention-policies"));
const search_1 = __importDefault(require("./managers/search"));
const shared_items_1 = __importDefault(require("./managers/shared-items"));
const sign_requests_generated_1 = __importDefault(require("./managers/sign-requests.generated"));
const sign_templates_generated_1 = __importDefault(require("./managers/sign-templates.generated"));
const storage_policies_1 = __importDefault(require("./managers/storage-policies"));
const tasks_1 = __importDefault(require("./managers/tasks"));
const terms_of_service_1 = __importDefault(require("./managers/terms-of-service"));
const trash_1 = __importDefault(require("./managers/trash"));
const users_1 = __importDefault(require("./managers/users"));
const web_links_1 = __importDefault(require("./managers/web-links"));
const webhooks_1 = __importDefault(require("./managers/webhooks"));
const file_requests_manager_1 = __importDefault(require("./managers/file-requests-manager"));
const shield_information_barriers_generated_1 = __importDefault(require("./managers/shield-information-barriers.generated"));
const shield_information_barrier_segments_generated_1 = __importDefault(require("./managers/shield-information-barrier-segments.generated"));
const shield_information_barrier_segment_members_generated_1 = __importDefault(require("./managers/shield-information-barrier-segment-members.generated"));
const shield_information_barrier_segment_restrictions_generated_1 = __importDefault(require("./managers/shield-information-barrier-segment-restrictions.generated"));
const shield_information_barrier_reports_generated_1 = __importDefault(require("./managers/shield-information-barrier-reports.generated"));
const integration_mappings_1 = __importDefault(require("./managers/integration-mappings"));
// ------------------------------------------------------------------------------
// Requirements
// ------------------------------------------------------------------------------
