...
class StoragePolicyAssignmentsManager {
    ...
    async getStoragePolicyAssignments(queryParams, optionalsInput = {}) {
        ...
        return {
            ...(0, storagePolicyAssignments_generated_js_1.deserializeStoragePolicyAssignments)(response.data),
    ...
    async createStoragePolicyAssignment(requestBody, optionalsInput = {}) {
        ...
        return {
            ...(0, storagePolicyAssignment_generated_js_1.deserializeStoragePolicyAssignment)(response.data),
            rawData: response.data,
        };
    }
    /**
