...
class ListCollaborationsManager {
    ...
    async getFileCollaborations(fileId, optionalsInput = {}) {
        ...
        return {
            ...(0, collaborations_generated_js_1.deserializeCollaborations)(response.data),
    ...
    async getCollaborations(queryParams, optionalsInput = {}) {
        ...
        return {
            ...(0, collaborationsOffsetPaginated_generated_js_1.deserializeCollaborationsOffsetPaginated)(response.data),
            rawData: response.data,
        };
    }
    /**
