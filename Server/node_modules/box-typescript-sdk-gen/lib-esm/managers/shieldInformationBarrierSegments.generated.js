...
class ShieldInformationBarrierSegmentsManager {
    ...
    async getShieldInformationBarrierSegmentById(shieldInformationBarrierSegmentId, optionalsInput = {}) {
        ...
        return {
            ...(0, shieldInformationBarrierSegment_generated_js_1.deserializeShieldInformationBarrierSegment)(response.data),
    ...
    async getShieldInformationBarrierSegments(queryParams, optionalsInput = {}) {
        ...
        return {
            ...(0, shieldInformationBarrierSegments_generated_js_1.deserializeShieldInformationBarrierSegments)(response.data),
            rawData: response.data,
        };
    }
    /**
