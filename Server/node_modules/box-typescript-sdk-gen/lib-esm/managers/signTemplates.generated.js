...
class GetSignTemplateByIdOptionals {
    headers = new GetSignTemplateByIdHeaders({});
...
class SignTemplatesManager {
    ...
    async getSignTemplates(queryParams = {}, headersInput = new GetSignTemplatesHeaders({}), cancellationToken) {
        ...
        return {
            ...(0, signTemplates_generated_js_1.deserializeSignTemplates)(response.data),
    ...
    async getSignTemplateById(templateId, optionalsInput = {}) {
        ...
        return {
            ...(0, signTemplate_generated_js_1.deserializeSignTemplate)(response.data),
            rawData: response.data,
        };
    }
}
