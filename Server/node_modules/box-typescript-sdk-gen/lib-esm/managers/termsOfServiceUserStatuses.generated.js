...
class TermsOfServiceUserStatusesManager {
    ...
    async getTermsOfServiceUserStatuses(queryParams, optionalsInput = {}) {
        ...
        return {
            ...(0, termsOfServiceUserStatuses_generated_js_1.deserializeTermsOfServiceUserStatuses)(response.data),
    ...
    async createTermsOfServiceStatusForUser(requestBody, optionalsInput = {}) {
        ...
        return {
            ...(0, termsOfServiceUserStatus_generated_js_1.deserializeTermsOfServiceUserStatus)(response.data),
            rawData: response.data,
        };
    }
    /**
