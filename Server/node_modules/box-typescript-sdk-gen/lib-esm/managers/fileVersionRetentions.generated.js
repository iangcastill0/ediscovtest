...
class GetFileVersionRetentionByIdOptionals {
    headers = new GetFileVersionRetentionByIdHeaders({});
...
class FileVersionRetentionsManager {
    ...
    async getFileVersionRetentions(queryParams = {}, headersInput = new GetFileVersionRetentionsHeaders({}), cancellationToken) {
        ...
        return {
            ...(0, fileVersionRetentions_generated_js_1.deserializeFileVersionRetentions)(response.data),
    ...
    async getFileVersionRetentionById(fileVersionRetentionId, optionalsInput = {}) {
        ...
        return {
            ...(0, fileVersionRetention_generated_js_1.deserializeFileVersionRetention)(response.data),
            rawData: response.data,
        };
    }
}
