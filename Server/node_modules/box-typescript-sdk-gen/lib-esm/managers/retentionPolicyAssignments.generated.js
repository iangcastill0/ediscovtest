...
class RetentionPolicyAssignmentsManager {
    ...
    async getRetentionPolicyAssignments(retentionPolicyId, optionalsInput = {}) {
        ...
        return {
            ...(0, retentionPolicyAssignments_generated_js_1.deserializeRetentionPolicyAssignments)(response.data),
    ...
    async createRetentionPolicyAssignment(requestBody, optionalsInput = {}) {
        ...
        return {
            ...(0, retentionPolicyAssignment_generated_js_1.deserializeRetentionPolicyAssignment)(response.data),
            rawData: response.data,
        };
    }
    /**
    ...
    async getFilesUnderRetentionPolicyAssignment(retentionPolicyAssignmentId, optionalsInput = {}) {
        ...
        return {
            ...(0, filesUnderRetention_generated_js_1.deserializeFilesUnderRetention)(response.data),
            rawData: response.data,
        };
    }
}
