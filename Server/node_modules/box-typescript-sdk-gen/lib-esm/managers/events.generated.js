...
const eventStream_js_1 = require("../box/eventStream.js");
...
class EventsManager {
    ...
    async getEventsWithLongPolling(headersInput = new GetEventsWithLongPollingHeaders({}), cancellationToken) {
        ...
        const headersMap = (0, utils_js_2.prepareParams)({ ...{}, ...headers.extraHeaders });
        ...
        return {
            ...(0, realtimeServers_generated_js_1.deserializeRealtimeServers)(response.data),
    ...
    async getEvents(queryParams = {}, headersInput = new GetEventsHeaders({}), cancellationToken) {
        ...
        return {
            ...(0, events_generated_js_1.deserializeEvents)(response.data),
            rawData: response.data,
        };
    }
    /**
    ...
    getEventStream(queryParams = {}, headersInput = new GetEventStreamHeaders({}), cancellationToken) {
        ...
        return new eventStream_js_1.EventStream({
            eventsManager: this,
