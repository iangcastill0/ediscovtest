...
class SearchManager {
    ...
    async searchByMetadataQuery(requestBody, optionalsInput = {}) {
        ...
        return {
            ...(0, metadataQueryResults_generated_js_1.deserializeMetadataQueryResults)(response.data),
    ...
    async searchForContent(queryParams = {}, headersInput = new SearchForContentHeaders({}), cancellationToken) {
        ...
        return {
            ...(0, searchResultsOrSearchResultsWithSharedLinks_generated_js_1.deserializeSearchResultsOrSearchResultsWithSharedLinks)(response.data),
            rawData: response.data,
        };
    }
}
