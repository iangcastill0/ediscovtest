...
class ShieldInformationBarrierSegmentMembersManager {
    ...
    async getShieldInformationBarrierSegmentMemberById(shieldInformationBarrierSegmentMemberId, optionalsInput = {}) {
        ...
        return {
            ...(0, shieldInformationBarrierSegmentMember_generated_js_1.deserializeShieldInformationBarrierSegmentMember)(response.data),
    ...
    async getShieldInformationBarrierSegmentMembers(queryParams, optionalsInput = {}) {
        ...
        return {
            ...(0, shieldInformationBarrierSegmentMembers_generated_js_1.deserializeShieldInformationBarrierSegmentMembers)(response.data),
            rawData: response.data,
        };
    }
    /**
