...
class CreateAiAskOptionals {
    headers = new CreateAiAskHeaders({});
...
class CreateAiTextGenOptionals {
    headers = new CreateAiTextGenHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
class GetAiAgentDefaultConfigOptionals {
    headers = new GetAiAgentDefaultConfigHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
class CreateAiExtractOptionals {
    headers = new CreateAiExtractHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
class CreateAiExtractStructuredOptionals {
    headers = new CreateAiExtractStructuredHeaders({});
    cancellationToken = void 0;
    constructor(fields) {
        if (fields.headers !== undefined) {
            this.headers = fields.headers;
...
class AiManager {
    ...
    async createAiAsk(requestBody, optionalsInput = {}) {
        ...
        return {
            ...(0, aiResponseFull_generated_js_1.deserializeAiResponseFull)(response.data),
    ...
    async createAiTextGen(requestBody, optionalsInput = {}) {
        ...
        return {
            ...(0, aiResponse_generated_js_1.deserializeAiResponse)(response.data),
            rawData: response.data,
        };
    }
    /**
    ...
    async getAiAgentDefaultConfig(queryParams, optionalsInput = {}) {
        ...
        return {
            ...(0, aiAgentAskOrAiAgentExtractOrAiAgentExtractStructuredOrAiAgentTextGen_generated_js_1.deserializeAiAgentAskOrAiAgentExtractOrAiAgentExtractStructuredOrAiAgentTextGen)(response.data),
            rawData: response.data,
        };
    }
    /**
    ...
    async createAiExtractStructured(requestBody, optionalsInput = {}) {
        ...
        return {
            ...(0, aiExtractStructuredResponse_generated_js_1.deserializeAiExtractStructuredResponse)(response.data),
            rawData: response.data,
        };
    }
}
