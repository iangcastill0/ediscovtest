...
test('testCreateUpdateGetDeleteRetentionPolicy', async function testCreateUpdateGetDeleteRetentionPolicy() {
    ...
    const folder = await (0, commons_generated_js_1.createNewFolder)();
    const retentionPolicyAssignment = await exports.client.retentionPolicyAssignments.createRetentionPolicyAssignment({
    ...
    const files = await exports.client.uploads.uploadFile({
        attributes: {
    ...
    const newFiles = await exports.client.uploads.uploadFileVersion(file.id, {
        attributes: {
            name: file.name,
        },
    ...
    const fileVersionRetentions = await exports.client.fileVersionRetentions.getFileVersionRetentions();
    ...
    const fileVersionRetentionById = await exports.client.fileVersionRetentions.getFileVersionRetentionById(fileVersionRetention.id);
