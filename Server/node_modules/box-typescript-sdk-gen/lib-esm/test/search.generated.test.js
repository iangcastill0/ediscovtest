...
test('testCreateMetaDataQueryExecuteRead', async function testCreateMetaDataQueryExecuteRead() {
    ...
    const metadata = await exports.client.fileMetadata.createFileMetadataById(file.id, 'enterprise', templateKey, {
        ['name']: 'John',
        ['age']: 23,
    ...
    await (0, utils_js_4.delayInSeconds)(5);
    const searchFrom = ''.concat(template.scope, '.', template.templateKey);
    const query = await exports.client.search.searchByMetadataQuery({
        ancestorFolderId: '0',
        from: searchFrom,
    ...
    await exports.client.metadataTemplates.deleteMetadataTemplate('enterprise', template.templateKey);
...
test('testMetadataFilters', async function testMetadataFilters() {
    ...
    const query = await exports.client.search.searchForContent({
        ancestorFolderIds: ['0'],
        mdfilters: [
            {
...
test('testGetSearch', async function testGetSearch() {
    const keyword = 'test';
    const search = await exports.client.search.searchForContent({
        ancestorFolderIds: ['0'],
        query: keyword,
    ...
    const searchWithSharedLink = await exports.client.search.searchForContent({
        ancestorFolderIds: ['0'],
        query: keyword,
        trashContent: 'non_trashed_only',
