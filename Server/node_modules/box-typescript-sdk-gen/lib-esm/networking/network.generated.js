...
class NetworkSession {
    ...
    interceptors = [];
    agent = (0, utils_js_1.createAgent)(void 0, void 0);
    agentOptions;
    proxyConfig;
    networkClient = new boxNetworkClient_js_1.BoxNetworkClient({});
    retryStrategy = new retries_generated_js_1.BoxRetryStrategy({});
    dataSanitizer = new logging_generated_js_1.DataSanitizer({});
    constructor(fields) {
