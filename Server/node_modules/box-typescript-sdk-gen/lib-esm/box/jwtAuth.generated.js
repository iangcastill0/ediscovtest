...
class JwtConfig {
    ...
    userId;
    algorithm = 'RS256';
    tokenStorage = new tokenStorage_generated_js_1.InMemoryTokenStorage({});
    privateKeyDecryptor = new utils_js_6.DefaultPrivateKeyDecryptor({});
    constructor(fields) {
    ...
    static fromConfigJsonString(configJsonString, tokenStorage, privateKeyDecryptor) {
        const configJson = {
            ...deserializeJwtConfigFile((0, json_js_1.jsonToSerializedData)(configJsonString)),
            rawData: (0, json_js_1.jsonToSerializedData)(configJsonString),
        };
...
class BoxJwtAuth {
    ...
    async refreshToken(networkSession) {
        ...
        const assertion = await (0, utils_js_5.createJwtAssertion)(claims, jwtKey, jwtOptions);
