        ...
        if (newString) {
            const newRows = rows.filter((row) => {
                ...
                properties.forEach((property) => {
                    if (row.actor.user.displayName.toString().toLowerCase().includes(newString.toString().toLowerCase())) {
                        containsQuery = true;
                    }
                });
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {' '}
                                                        {Object.keys(row.action).join(', ')}{' '}
                                                    </Typography>
                                                </TableCell>
                                                <TableCell>{row.actor.user.displayName}</TableCell>
                                                <TableCell align="left">{new Date(row.times.recordedDateTime).toLocaleString()}</TableCell>
                                                <TableCell
                                                    component="th"
                                                    id={cellId}
                                                    scope="row"
