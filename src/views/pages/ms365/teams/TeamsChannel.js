...
const TeamsChannel = ({ msgList }) => {
    ...
    const { teamsData, getJsonOfTeam } = React.useContext(MSTeamsContext);
    ...
    const getJsonData = async (event, siteId) => {
        setLoading(true);
        await getJsonOfTeam(accessToken, siteId);
        setLoading(false);
        ...
        <MainCard content={false}>
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell
                                                    ...
                                                    id={cellId}
                                                    scope="row"
                                                    onClick={(event) => getJsonData(event, row.id)}
                                                    sx={{ cursor: 'pointer' }}
                                                >
            ...
            {isListsView &&
                <>
                    ...
                    <div>
                        <pre>{JSON.stringify(teamsData.JsonOfTeam, null, 2)}</pre>
                    </div>
                </>}
        </MainCard>
    );
