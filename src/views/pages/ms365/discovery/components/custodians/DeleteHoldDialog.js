...
import { deleteHoldItem } from '../../services/EdiscoveryService';
import { useGlobalState } from '../../state/globalState';

export const DeleteHoldDialog = ({ onDismiss, deleteId }) => {
  ...
  const handleDelete = async () => {
    ...
    if(deleteId !== '' && deleteId){
      const result = await deleteHoldItem(currentCase, deleteId);
  ...
  return (
    <>
      ...
      >
        If you delete this hold, all holds will be turned off. Any content that was on hold will be released, and data will be lost. Are you sure you want to delete this hold?
...
export default DeleteHoldDialog;