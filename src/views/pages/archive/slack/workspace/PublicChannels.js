...
const ArchivePublicChannels = ({ channels,members, teamId, backupId }) => {
    ...
    const goMessages = (event, id, name) => {
        ...
        navigate(`/archive/Slack/${teamId}/public-channel/${name}/${id}/backup/${backupId}`);
    }
    ...
    return (
        <MainCard title="Public Channels" content={false}>
            <CardContent>
...
ArchivePublicChannels.propTypes = {
...
export default ArchivePublicChannels;
