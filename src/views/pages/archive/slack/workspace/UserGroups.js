...
const ArchiveUserGroups = ({ channels,members, teamId, backupId }) => {
    ...
    const goMessages = (event, id, name) => {
        ...
        navigate(`/archive/Slack/${teamId}/user-groups/${name}/${id}/backup/${backupId}`);
    }
...
export default ArchiveUserGroups;
