...
const DropboxTabs = () => {
    ...
    const { workspaceId, archiveId } = useParams();
    // set selected tab
    ...
    return (
        <MainCard title={`Dropbox Archive ${title}`} backButton>
            ...
            <TabPanel value={value} index={0}>
                <Files workspaceId={workspaceId} archiveId={archiveId}/>
            </TabPanel>
            <TabPanel value={value} index={1}>
                <Shared workspaceId={workspaceId} archiveId={archiveId} />
            </TabPanel>
            <TabPanel value={value} index={2}>
                <Deleted workspaceId={workspaceId} archiveId={archiveId} />
            </TabPanel>
            <TabPanel value={value} index={3}>
                <ActivityLogs workspaceId={workspaceId} archiveId={archiveId} />
            </TabPanel>
