...
const PrivateChannels = ({ channels, members, teamId, userId }) => {
    ...
    const handleSearch = (event) => {
        ...
        if (newString) {
            const newRows = channels.filter((row) => {
                let matches = true;
    ...
    const goMessages = (event, id, name) => {
        ...
        navigate(`/slack/team/${teamId}/users/${userId}/private-channel/${name}/${id}`);
    }
