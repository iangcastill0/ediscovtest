...
import { exportToZip, exportToPDF, exportToJSON, getPrivateChannelMessages2, getSlackImage, emojis } from 'utils/apiHelper';
...
const PrivateChannelMessages = () => {
    ...
    React.useEffect(() => {
        const fetchData = async () => {
            setLoading(true);
            const data = await getPrivateChannelMessages2({ teamId, userId, channelId });
    ...
    React.useEffect(() => {
        const fetchData = async (cursor) => {
            ...
            setLoading(true);
            const data = await getPrivateChannelMessages2({ teamId, userId, channelId, cursor });
