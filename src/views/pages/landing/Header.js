            ...
            >
                <Grid item xs={12} md={12}>
                            ...
                            >
                                ...
                                >
                                    <Box component="span" sx={{ color: theme.palette.primary.main }}>
                                        Forensic Archiving and Searching of Online Platforms in a Single, Unified Interface.
                                    </Box>
                                </Typography>
                            </motion.div>
                        </Grid>
                    ...
                    <Grid item xs={12} md={5}>
                        <Grid container spacing={gridSpacing} sx={{ pr: 2, [theme.breakpoints.down('lg')]: { pr: 0, textAlign: 'center' } }}>
                            <Grid item xs={12}>
                                <motion.div
                                    initial={{ opacity: 0, translateY: 550 }}
                                    animate={{ opacity: 1, translateY: 0 }}
                                ...
                                >
                                    ...
                                    >
                                        Complete Discovery is a unified archiving and forensic tool that analysts, corporate security, and DR professionals use to access, archive, search, and present cloud and mobile data in a single, easy-to-use interface.
                                    </Typography>
                                </motion.div>
                            </Grid>
                                    ...
                                    >
                                        ...
                                        <Grid item xs zeroMinWidth>
                                            <Typography variant="h4" component="div" color="inherit" sx={{ fontWeight: 400, lineHeight: 1.4 }}>
                                                <b>A single platform to backup data for all your SaaS apps</b>
                                            </Typography>
                                        </Grid>
                                    </Grid>
                                </motion.div> */}
                    ...
                    <Grid item xs={12} md={7} sx={{ display: { xs: 'none', md: 'flex' } }}>
                        <Box sx={{ position: 'relative', mt: 8.75 }}>
                            <HeaderImage src={dashboard} alt="Complete Discovery" />
                            <Box
                                sx={{
                                    position: 'absolute',
                                    top: '-110px',
                            ...
                            >
                                ...
                                >
                                    <HeaderAnimationImage src={widget1} alt="Evestigate" />
                                </motion.div>
                            </Box>
                            <Box
                                sx={{
                            ...
                            >
                                ...
                                >
                                    <HeaderAnimationImage src={widget2} alt="Evestigate" />
                                </motion.div>
                            </Box>
                        </Box>
                    </Grid>
