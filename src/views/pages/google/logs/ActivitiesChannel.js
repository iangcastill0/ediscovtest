...
const ActivitiesChannel = ({ msgList }) => {
        ...
        if (newString) {
            const newRows = rows.filter((row) => {
                ...
                properties.forEach((property) => {
                    if (row.actor.email.toString().toLowerCase().includes(newString.toString().toLowerCase())) {
                        containsQuery = true;
                    }
                });
                                    ...
                                    .map((row, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell align="left">{new Date(row.id.time).toLocaleString()}</TableCell>
                                                <TableCell
                                                    component="th"
                                                    id={cellId}
                                                    scope="row"
...
ActivitiesChannel.propTypes = {
    msgList: PropTypes.array.isRequired,
};

export default ActivitiesChannel;