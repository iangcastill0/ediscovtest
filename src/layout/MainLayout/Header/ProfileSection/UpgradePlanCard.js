...
import { Button, Card, CardContent, Grid, Stack, Typography, Link } from '@mui/material';
            ...
            <CardContent>
                <Grid container direction="column" spacing={2}>
                    ...
                    <Grid item>
                        <Stack direction="row">
                            <AnimateButton>
                                <Button component={Link} href='/billing' variant="contained" color="warning" sx={{ boxShadow: 'none' }}>
                                    Go Premium
                                </Button>
                            </AnimateButton>
                        </Stack>
