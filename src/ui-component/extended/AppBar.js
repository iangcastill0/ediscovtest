...
import imgLogo from 'assets/images/gdf-logo.png';
                    ...
                    <Toolbar>
                        {/* <Typography component="div" sx={{textAlign: 'left' }}> */}
                            <Link href='#' style={{width: '40%'}}>
                                <img src={imgLogo} alt="Evestigate" width='90%'/>
                            </Link>
                            {/* <Logo /> */}
                        {/* </Typography> */}
                        <Stack direction="row" sx={{ display: { xs: 'none', sm: 'block' },textAlign: 'right'}} spacing={2}>
